  ...
  return (
    <>
      <Header>
        ...
        <Link href="/dashboard">
          <svg css={css`color: var(--grey-3); &:hover { color: var(--grey-4) }; cursor: pointer; transition: color 0.2s ease;`} width="21" height="21" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
